  ...
  return (
    <PageShell>
      <main className="p-5 md:p-8 max-w-7xl mx-auto">
        <TopHeader
          title="Playlists"
          subtitle="책 분위기에 어울리는 음악을 검색하고 플레이리스트에 저장합니다."
          right={
            <div className="hidden sm:inline-flex items-center gap-2 rounded-2xl bg-pink-50 text-pink-600 px-4 py-3 text-sm font-bold">
              <Music2 size={17} />
              Real Music API
            </div>
          }
        ...
        <section className="grid xl:grid-cols-[360px_1fr] gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-pink-100"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handlePlaylistChange}
                    rows={3}
                    className="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-pink-100 resize-none"
                ...
                <button
                  type="submit"
                  disabled={creating}
                  className="w-full bg-pink-600 text-white rounded-xl py-3 text-sm font-bold hover:bg-pink-700 disabled:opacity-50"
                >
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            ...
                            {playlist.total_likes} likes
                          </p>
                        </div>

                        <Music size={17} className="text-pink-500" />
                      </div>
                    </button>
                  ))}
                </div>
            ...
            {!selectedPlaylist ? (
              <div className="card p-10 text-center">
                ...
                <p className="text-sm text-slate-500 mt-2">
                  왼쪽에서 생성하거나 기존 플레이리스트를 선택하면 노래를 추가할 수 있습니다.
                </p>
              </div>
            ) : (
              <>
                <div className="card p-6">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="w-14 h-14 rounded-2xl bg-pink-50 text-pink-600 flex items-center justify-center mb-4">
                        <Music2 size={26} />
                      </div>
                ...
                <form onSubmit={handleSearchMusic} className="card p-6">
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-pink-100"
                    ...
                    <button
                      ...
                      className="bg-pink-600 text-white rounded-xl px-5 py-3 text-sm font-bold hover:bg-pink-700 disabled:opacity-50"
                    >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            <button
                              ...
                              className="rounded-xl bg-blue-600 text-white px-4 py-2 text-sm font-bold hover:bg-blue-700"
                            >
                              Add
                            </button>
                          </div>
                ...
                <form onSubmit={handleAddSong} className="card p-6">
                  ...
                  <div className="grid md:grid-cols-[1fr_1fr_1.2fr_auto] gap-3">
                    <input
                      ...
                      className="rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-pink-100"
                        ...
                        .map((song, index) => (
                          ...
                          >
                            <div className="flex items-center gap-4 min-w-0">
                              <div className="w-10 h-10 rounded-xl bg-slate-100 text-slate-600 flex items-center justify-center font-black text-sm">
                                #{index + 1}
                              </div>
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                ...
                                className="inline-flex items-center gap-2 rounded-xl bg-pink-50 text-pink-600 px-3 py-2 text-sm font-bold hover:bg-pink-100"
                              >
                                <Heart size={15} />
                                {song.like_count}
                              </button>
