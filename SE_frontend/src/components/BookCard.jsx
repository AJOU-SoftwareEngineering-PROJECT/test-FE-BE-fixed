...
export default function BookCard({ book }) {
  ...
  return (
    ...
    >
      <div className="h-64 bg-gradient-to-br from-blue-100 via-slate-100 to-white flex items-center justify-center">
      ...
      <div className="p-5">
        <h3 className="font-black text-blue-600 line-clamp-1">{title}</h3>

        <p className="text-sm text-slate-500 mt-1">by {author}</p>
